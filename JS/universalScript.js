...
$("#nav-colors > .btn").click(function(){
	...
	} else if($(this).is("#dark-mode")) {
		$(".navbar").css("background","#4d4c4c");
		$(".dropdown-menu").css("background","#4d4c4c");
		$(".navbar .fa, .link, a").css("color","white");
		$(".icon-bar").css("background","white");
	} else if($(this).is("#light-mode")) {
		$(".navbar").css("background","#dbd9d9");
		$(".dropdown-menu").css("background","#dbd9d9");
